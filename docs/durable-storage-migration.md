...
`CursorJob` currently produces 216 persisted field names, including the
...
| Baseline | Count |
|---|---:|
| Persisted field names | 218 |
| Named table fields | 213 |
| Import-only fields | 4 |
| Directly exposed `CursorJob` properties | 157 |
