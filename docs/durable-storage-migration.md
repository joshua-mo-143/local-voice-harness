...
`CursorJob` currently produces 323 persisted field names, including the
...
| Baseline | Count |
|---|---:|
| Persisted field names | 323 |
| Named table fields | 318 |
| Import-only fields | 4 |
| Directly exposed `CursorJob` properties | 262 |
| Compatibility adapters | 38 |
| Public transition entry points | 84 |
| Documented duplicate authorities | 0 |
| Lifecycle-related module lines | 35563 |
