...
class DistroPackageAdapterTests(unittest.TestCase):
    ...
    def test_package_names_are_mapped_per_family(self) -> None:
        ...
        self.assertIn("pipewire-audio", arch.packages)
        self.assertIn("wireplumber", arch.packages)
        ...
        self.assertIn("pipewire-bin", debian.packages)
        self.assertIn("wireplumber", debian.packages)
        ...
        self.assertIn("pipewire-utils", fedora.packages)
        self.assertIn("wireplumber", fedora.packages)
