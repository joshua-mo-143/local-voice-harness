...
ROUTER_SYSTEM_PROMPT = (
    ...
    "Use workspace_consultation for a read-only review or summarize of an existing "
    "GitHub or Linear ticket. Do not use cursor_submit for reviewing or summarizing "
    "a ticket. "
