...
def cursor_prompt(
    ...
    *,
    ...
    return prompt + (
        ...
        "use subagents, run them only in the foreground and wait for every subagent and "
        "tool call to finish before responding. Never leave background work running. "
        ...
        "by a plain-text summary of at most 20 words. Emit the summary only after all "
        "subagents and tool calls have reached a terminal state."
