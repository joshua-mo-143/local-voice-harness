        ...
        _fields(
            {
                ...
                "github_issue_update_requested": CrashKind.CONTENT,
                ...
                "github_issue_close_requested": CrashKind.CONTENT,
                "github_issue_close_confirmed": CrashKind.UNCERTAINTY,
                "github_issue_close_marker": CrashKind.TOKEN,
                "github_issue_close_operation_state": CrashKind.UNCERTAINTY,
                "github_issue_split_requested": CrashKind.CONTENT,
                "github_issue_merge_requested": CrashKind.CONTENT,
                ...
                "linear_ticket_update_requested": CrashKind.CONTENT,
                ...
                "linear_ticket_update_prompt_target": CrashKind.IDENTITY,
                "linear_ticket_update_prompt_session": CrashKind.IDENTITY,
                "linear_ticket_update_prompt_token": CrashKind.TOKEN,
                "linear_ticket_update_baseline_sequence": CrashKind.COUNTER,
                "linear_ticket_close_requested": CrashKind.CONTENT,
                "linear_ticket_close_confirmed": CrashKind.UNCERTAINTY,
                ...
                "linear_ticket_close_baseline_sequence": CrashKind.COUNTER,
                "linear_ticket_split_requested": CrashKind.CONTENT,
                "ticket_split_confirmed": CrashKind.UNCERTAINTY,
                "ticket_split_parent_action": CrashKind.CONTENT,
                "ticket_split_parent_title": CrashKind.CONTENT,
                "ticket_split_parent_body": CrashKind.CONTENT,
                ...
                "ticket_split_team_id": CrashKind.IDENTITY,
                "ticket_split_prompt_target": CrashKind.IDENTITY,
                "ticket_split_prompt_session": CrashKind.IDENTITY,
                "ticket_split_prompt_token": CrashKind.TOKEN,
                "ticket_split_baseline_sequence": CrashKind.COUNTER,
                "linear_ticket_merge_requested": CrashKind.CONTENT,
                "ticket_merge_confirmed": CrashKind.UNCERTAINTY,
                "ticket_merge_survivor": CrashKind.IDENTITY,
                "ticket_merge_survivor_title": CrashKind.CONTENT,
                "ticket_merge_survivor_body": CrashKind.CONTENT,
                "ticket_merge_survivor_marker": CrashKind.TOKEN,
                ...
                "ticket_merge_prompt_token": CrashKind.TOKEN,
                "ticket_merge_baseline_sequence": CrashKind.COUNTER,
            },
            submachine="ticket",
            typed_runtime="CursorJob provider ticket fields",
            transition_owner="cursor.provisioning ticket create, update, close, split, and merge helpers / recovery ticket reconcile",
            adapter="CursorJob.from_dict",
            callers=(
                ...
                "cursor.provisioning._run_github_issue_update",
                "cursor.provisioning._run_linear_ticket_update",
                "cursor.provisioning._run_github_issue_close",
                "cursor.provisioning._run_linear_ticket_close",
                "cursor.provisioning._run_ticket_split",
                "cursor.provisioning._run_ticket_merge",
                ...
                "cursor.recovery.reconcile_uncertain_issue_update",
                "cursor.recovery.reconcile_uncertain_linear_ticket_update",
                "cursor.recovery.reconcile_uncertain_issue_close",
                "cursor.recovery.reconcile_uncertain_linear_ticket_close",
                "cursor.recovery.reconcile_uncertain_ticket_split",
                "cursor.recovery.reconcile_uncertain_ticket_merge",
            ),
        )
    )
    rows.extend(
...
TRANSITION_ENTRY_POINTS: tuple[TransitionEntry, ...] = (
    ...
    _entry(
        "local_voice_harness.cursor.recovery.reconcile_uncertain_issue_update",
        "cursor.recovery",
        "GitHub issue-update observation",
        AuthorityKind.CALLER_INTERPRETS,
    ),
    _entry(
        "local_voice_harness.cursor.recovery.reconcile_uncertain_linear_ticket_update",
        "cursor.recovery",
        "Linear ticket-update observation",
        AuthorityKind.CALLER_INTERPRETS,
    ),
    _entry(
        "local_voice_harness.cursor.recovery.reconcile_uncertain_issue_close",
        "cursor.recovery",
        "GitHub issue-close observation",
        AuthorityKind.CALLER_INTERPRETS,
    ),
    _entry(
        "local_voice_harness.cursor.recovery.reconcile_uncertain_linear_ticket_close",
        "cursor.recovery",
        "Linear ticket-close observation",
        AuthorityKind.CALLER_INTERPRETS,
    ),
    _entry(
        "local_voice_harness.cursor.recovery.reconcile_uncertain_ticket_split",
        "cursor.recovery",
        "ticket-split observation without retrying landed writes",
        AuthorityKind.CALLER_INTERPRETS,
    ),
    _entry(
        "local_voice_harness.cursor.recovery.reconcile_uncertain_ticket_merge",
        "cursor.recovery",
        "ticket-merge observation without retrying landed writes",
        AuthorityKind.CALLER_INTERPRETS,
    ),
    _entry(
