...
OPTIONAL_ENVIRONMENT_POLICY: dict[str, dict[str, str]] = {
    ...
    "voice-harness-wake.service": {
        ...
        "VOICE_HARNESS_HERDR_WORKTREE_ROOT": "absolute_path",
        "VOICE_HARNESS_GH_BIN": "absolute_path",
        "VOICE_HARNESS_GIT_BIN": "absolute_path",
        "VOICE_HARNESS_GITHUB_TIMEOUT_SECONDS": "positive_float",
        "VOICE_HARNESS_HERDR_TIMEOUT_SECONDS": "positive_float",
