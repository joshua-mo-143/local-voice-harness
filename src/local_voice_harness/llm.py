...
TOOL_ENABLED_PROMPT = (
    ...
    "sentence using the speakable job label from the tool result. Never speak a hexadecimal "
    "job id. When the tool reports that an issue or ticket is complete, respond only with "
...
def qwen_turn(
    ...
    *,
    ...
    messages: list[dict[str, object]] = [
        ...
        *[dict(message) for message in (history or [])[-8:]],
            ...
            if name != "cursor":
                ...
                if action in {"submit", "reply"} and not task:
                    ...
                    try:
                        ...
                        tool_result = as_assistant_response(turn_response).spoken_text
